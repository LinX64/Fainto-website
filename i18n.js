window.__I18N = {
  de: {
    ...
    "hero.lede":
      "Ein privater Budget-Tracker mit KI-Coach direkt auf dem Gerät — echte Sprachmodelle, die deine Ausgaben lesen, nicht die Cloud.",
  ...
  pl: {
    ...
    "hero.lede":
      "Prywatny menedżer budżetu z trenerem AI działającym na urządzeniu — prawdziwe modele językowe analizują Twoje wydatki, a nie chmura.",
  ...
  fa: {
    ...
    "hero.lede":
      "یک ردیاب بودجهٔ خصوصی با مربی هوش مصنوعی روی دستگاه — مدل‌های زبانی واقعی که خرج‌وخرید شما را می‌خوانند، نه ابر.",
  ...
  tr: {
    ...
    "hero.lede":
      "Cihaz üzerinde çalışan yapay zekâ koçuna sahip gizlilik odaklı bir bütçe takipçisi — harcamalarınızı bulut değil, gerçek dil modelleri okur.",
