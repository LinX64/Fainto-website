...
window.FAINTO_I18N.pl = {
    ...
    "hero.slide1.alt": "Przegląd Fainto: analizy AI — wskazówka o optymalizacji podatkowej z limitem IKZE — nad kontami o łącznej wartości 191 000,00 zł.",
    "hero.slide2.alt": "Ekran główny Trenera AI Fainto działającego na urządzeniu: wybrany model SmolLM 135M, propozycje pytań o finanse, oznaczony jako Na urządzeniu · Prywatnie.",
    ...
    "features.seeit.p": "Ekran Przegląd łączy to wszystko w jedną całość: na górze spostrzeżenia AI — na przykład podatkowa wskazówka dla Polski, że wykorzystanie pełnego limitu IKZE (<strong>11 304,00 zł</strong>/rok) przy 32% stawce krańcowej oszczędza około <strong>3 617,28 zł</strong> rocznie — nad Twoimi kontami (w przykładzie <strong>191 000,00 zł</strong>) i nadchodzącymi rachunkami. Widok wartości netto sumuje Twoje aktywa — w przykładzie <strong>107 400,00 zł</strong> — w zestawieniu z zobowiązaniami. Każda liczba pozostaje na urządzeniu i należy wyłącznie do Ciebie. Dostępna już teraz na Androida — <a href=\"https://play.google.com/store/apps/details?id=com.vaultai.app\" target=\"_blank\" rel=\"noopener\">pobierz Fainto z Google Play</a> — a wersja na iOS pojawi się wkrótce.",
